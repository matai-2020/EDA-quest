...
export default class SkyScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet(
      "heart",
      "/assets/Game/Hearts/PNG/animated/border/heart_animated_2.png",
      {
        frameHeight: 17,
        frameWidth: 17,
      }
  ...
  create(prevLevel) {
    ...
    upDownPlatform = this.physics.add
      .image(600, 500, "smallPlatform")
      .setScale(0.4);
    ...
    leftRightPlatform = this.physics.add
      .image(1050, 600, "smallPlatform")
      .setScale(0.4);
    ...
    this.physics.add.collider(trigger, [
      platforms,
      upDownPlatform,
      leftRightPlatform,
    ]);
